...
require("lazy").setup({
  ...
  ------------------------------------------------------------------
  {
    ...
    opts = {
      style = "storm",
      transparent = true, -- don't paint a background, let WezTerm's transparency show through
      styles = {
    ...
    config = function(_, opts)
      ...
      -- Belt-and-suspenders: explicitly clear background on key highlight groups
